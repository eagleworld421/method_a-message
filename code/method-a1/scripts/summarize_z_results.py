...
def _metric_record(path: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "s_residual_margin": metrics["s"]["residual_margin"],
        "z_residual_margin": metrics["z"]["residual_margin"],
...
def main():
    ...
    metrics = [
        ...
        ("s_precision", "max"),
        ("z_precision", "max"),
        ("s_normal_nofault", "max"),
        ("z_normal_nofault", "max"),
        ("s_fault_global_min", "max"),
        ("z_fault_global_min", "max"),
        ("null_rate_p95", "min"),
    ]
